const playList = [
  ...
  {
    title: "C.C.Catch - Strangers By Night",
    src: "./assets/sounds/C.C.Catch - Strangers By Night.mp3",
    duration: '30'
  },
  {
    title: "Modern Talking - Cheri Cheri lady",
    src: "./assets/sounds/Modern Talking - Cheri Cheri lady.mp3",
    duration: '30'
  },
  
    {
      title: "Fancy - Bolero",
      src: "./assets/sounds/Fancy - Bolero.mp3",
      duration: '30'
    },
    {
      title: "Mauro - Buona Siera Siniorina",
      src: "./assets/sounds/Mauro - Buona Siera Siniorina.mp3",
      duration: '30'
    },
    {
      title: "Bad Boys Blue - Pretty Young Girl",
      src: "./assets/sounds/Bad Boys Blue - Pretty Young Girl.mp3",
      duration: '30'
    },
    {
      title: "Joy - Touch By Touch",
      src: "./assets/sounds/Joy - Touch By Touch.mp3",
      duration: '30'
    },
    {
      title: "C.C.Catch - Stop",
      src: "./assets/sounds/C.C.Catch - Stop - Draggin My Heart Around.mp3",
      duration: '30'
    },
    {
      title: "Patty Ryan - Love Is.mp3",
      src: "./assets/sounds/Patty Ryan - Love Is The Name Of The Game.mp3",
      duration: '30'
    },
    {
      title: "Boney M - Ma Baker",
      src: "./assets/sounds/Бони Эм - Ma Baker.mp3",
      duration: '30'
    },
    {
      title: "C.C.Catch - Heaven And Hell",
      src: "./assets/sounds/C.C.Catch - Heaven And Hell.mp3",
      duration: '30'
    },
    {
      title: "Bad Boys Blue - Gimme.mp3",
      src: "./assets/sounds/Bad Boys Blue - Gimme Gimme Your Lovin.mp3",
      duration: '30'
    }
...
const storageEventTarget = new StorageEventTarget();
